...
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (5,'Ferguson', 'Lucas', '1968-06-22', 'M', '1 Golf Hill', '9806688114');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (6,'Rees', 'Pippa', '1952-09-27', 'F', '42819 Columbus Hill', '7169836214');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (7,'Arnold', 'Edward', '1952-11-11', 'M', '02 Milwaukee Pass', '8674511069');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (8,'Sharp', 'Anthony', '1946-11-26', 'M', '65 Johnson Drive', '5564353334');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (9,'Ince', 'Wendy', '1958-06-29', 'F', '0 7th Court', '6316721449');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (10,'Ross', 'Tracey', '1949-12-07', 'F', '21362 Southridge Terrace', '6896698729');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (11,'Wilson', 'Claire', '1966-12-31', 'F', '69 Bayside Court', '3297190669');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (12,'Buckland', 'Max', '1945-06-24', 'M', '167 Rockefeller Crossing', '7731051856');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (13,'Clark', 'Natalie', '1964-06-18', 'F', '16 Mccormick Trail', '7501350501');
insert ignore into patients (id,last_name, first_name, date_of_birth, sex, address, phone_number) values (14,'Bailey', 'Piers', '1959-06-28', 'M', '9466 Ruskin Junction', '5031785593');
